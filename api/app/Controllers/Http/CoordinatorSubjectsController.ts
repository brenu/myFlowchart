      ...
      try {
        ...
        const subjectData = await request.validate({
          ...
          messages: {
            ...
            'theoretical_load.required': 'A carga-horária teórica é obrigatória',
            'practical_load.required': 'A carga-horária prática é obrigatória',
            'summary.required': 'A descrição é obrigatória',
            'objective.required': 'Os objetivos são obrigatórios',
            'methodology.required': 'A metodologia é obrigatória',
            'assessment.required': 'A avaliação é obrigatória',
