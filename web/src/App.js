        ...
        JSON.stringify([
          ...
          [
            ...
            },
            {
              ...
              name: 'Eletrônica',
              summary: 'Ementa legal aqui',
              prerequisites: ['CET-633', 'CET-634'],
            },
            {
              code: 'CET-642',
              name: 'Lógica Digital I',
              summary: 'Ementa legal aqui',
              prerequisites: ['CET-636'],
            },
            {
              code: 'CET-640',
              name: 'Fund. Matemáticos para Computação',
              summary: 'Ementa legal aqui',
              prerequisites: ['CET-636'],
            },
            {
          ...
          [
            ...
            },
            {
              ...
              summary: 'Ementa legal aqui',
              prerequisites: ['CET-638'],
            },
            {
              code: 'CET-065',
              name: 'Lógica Digital II',
              summary: 'Ementa legal aqui',
              prerequisites: ['CET-637', 'CET-642'],
            },
            {
              code: 'CAE-015',
