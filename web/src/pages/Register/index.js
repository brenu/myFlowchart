                    ...
                    <form onSubmit={handleSubmit}>
                        {step === 1 && (
                            <>
                                ...
                                <span>Já registrado? <Link to="/" style={linkStyle}>Efetuar login</Link></span>
                            ...
                            <>
                                {role === "student" ? (
                                    <>
                                        ...
                                        <select onChange={e => updateSelectedFlowcharts(e.target.value)}>
                                            <option value="">Selecione aqui</option>
                                            {flowcharts.filter(item => !selectedFlowcharts.includes(item))
                                                .map(flowchart => (
                                        ...
                                        <div style={{ overflow: "hidden" }}>
                                            {selectedFlowcharts.map(selectedFlowchart => (
                                                <div className="student-subject-container">
                                                    ...
                                                    <button type="button">
                                                        <FaTimes color="#FFF" size={16} onClick={() => setSelectedFlowcharts(selectedFlowcharts.filter(item => item.id != selectedFlowchart.id))} />
                                                    </button>
                                                </div>
                                            ))}
                                        </div>
